...
Prisma Client 是一个依据你的数据库 schema 自动生成的数据库的 client。 默认情况下, Prisma Client 生成到 `node_modules/.prisma/client` 文件夹, 但是 [你可以指定一个自定义位置](#using-a-custom-output-path).
...
![.prisma 和 @prisma 文件夹](https://www.prisma.io/docs/static/79546fa799b68a337dc6c9a2881d1cd0/3c492/prisma-client-node-module.png)
