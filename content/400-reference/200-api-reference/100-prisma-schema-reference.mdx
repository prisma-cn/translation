...
> 自版本 [2.17.0](https://github.com/prisma/prisma/releases/tag/2.17.0) `Float` 映射为 `Double` - 查看 [release notes](https://github.com/prisma/prisma/releases/tag/2.17.0) 和 [视频: Changes to the default mapping of Float in Prisma 2.17.0](https://www.bilibili.com/video/BV1UM4y1T7QF?p=10&share_source=copy_web) 了解更多.
