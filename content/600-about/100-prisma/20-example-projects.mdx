---
title: '示例项目'
metaTitle: '各种Prisma示例'
metaDescription: '与Prisma合作真实案例和产品的示例项目，以下一些开源项目，他们演示了实际用法。'
tocDepth: 2
---

## 使用 Prisma 的真实案例和产品的示例项目

下面是一些使用了 Prisma 的**真实应用程序**的开源项目。
如果你的产品应用程序是开源的，可以随时提交 PR 来添加你自己的生产应用程序。

- [真实世界评分应用程序的后端](https://github.com/2color/real-world-grading-app) (incl video and written tutorials)
- [Tottem--用于“社会图书馆管理”的全栈应用](https://github.com/poulainv/tottem) (based on Next.js)

## 现成的示例项目

你可以在[`prisma-examples`](https://github.com/prisma/prisma-examples/)存储库中找到许多**现成运行**示例项目，这些项目演示了 PRISMA 在各种用例中的用法。
